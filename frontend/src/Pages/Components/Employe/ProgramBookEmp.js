...
const ProgramBookEmp = () => {
    ...
    const columns = [
        ...
        { field: "program_date", headerName: "program_date", width: 130 },
        ...
        return (
            ...
            size="small" 
              ...
              style={{ cursor: "pointer" }} onClick={(e) => {
                ...
                navigate('/ViewOrderEmp', { state: { barcode_number: props.selectedRow.barcode_number } });
