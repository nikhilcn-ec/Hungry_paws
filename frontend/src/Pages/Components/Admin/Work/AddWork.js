...
const AddWork = ({ open, setOpen, isAddButton, rowData, setRefreshData}) => {
    ...
    const handleSubmit = (e) => {
        ...
        const method = "POST";
        if(isAddButton){           
            const data = {user_id:empid,title,description,image};
            const mainURL = URL+'/add';
            serviceMethod(mainURL,method,data, handleSuccess, handleException);
        }else{
            const data = {id,user_id:empid,title,description,image};
